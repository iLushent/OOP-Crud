...
$resepsionis = query("SELECT * FROM produk")
   ...
   <section id="hero" class="hero d-flex flex-column justify-content-center align-items-center" data-aos="fade" data-aos-delay="1500">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h2>Produk</h2>
                <a href="tambah_produk.php" class="btn btn-outline-light">Tambah Produk</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <table  border="1" class="table table-dark table-hover"class="d-flex flex-column justify-content-center align-items-center">
            <tr>
                <th><i class="fa-solid fa-list-ol"> NO</i></th>
                <th><i class="fa-solid fa-print"> Nama Produk</i></th>
                <th><i class="fa-solid fa-money-bill"> Harga</i></th>
                <th><i class="fa-solid fa-image"> Foto </i></th>
                <th><i class="fa-solid fa-circle-info"> Deskripsi</i></th>
                <th><i></i></th>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_produk.php?id=<?= $data["id_produk"]; ?>" class="edit"><i class="fa-solid fa-user-pen"></i></a>
